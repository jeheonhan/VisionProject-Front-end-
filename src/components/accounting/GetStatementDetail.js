...
class GetStatementDetail extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Dialog open={this.props.open} onClose={this.statementDetailClose}>
        ...
        <SwipeableViews
          ...
          <TabContainer dir={theme.direction}>
                ...
                <div align="center" style={{display:"block" }}>
                  <div style={{display:"inline"}} className="col-lg-6 col-sm-6 col-6">
                      <TextField style={{width:"255px", paddingRight:"70px"}}
                ...
                <div align="center" style={{display:"block" }}>
                  <div style={{display:"inline"}} className="col-lg-6 col-sm-6 col-6">
                      <TextField style={{paddingRight:"70px"}}
                          id="tradeAmount"
                          label="공급가액"
                          InputLabelProps={{
                          shrink: true,
