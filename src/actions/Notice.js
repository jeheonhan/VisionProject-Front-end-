...
export const getUpdateNoticeHeaderList = () => {
    return{
        type: GET_UPDATE_NOTICE_HEADER_LIST
    }
}

export const caaryUpdateNoticeHeaderList = (data) => {
    return{
        type: CARRY_UPDATE_NOTICE_HEADER_LIST,
        payload : data
    }
}